...
from networks.attention_is_all import GoogleTransformer
#from ultra.comprehension.parameter import user_params

class QAnetEmbedding(tf.layers.Layer):
    def __init__(self, params,feature_size:int, is_trainning=False, name="QAnetEmbedding", dtype=tf.float32):
